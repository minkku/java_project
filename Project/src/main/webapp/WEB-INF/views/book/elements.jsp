    ...
    <div class="container my-5">
      <div class="mb-5">
        <div class="owl-single dots-absolute owl-carousel">
          <img src="../resources/images/slider-1.jpg" alt="Free HTML Template by Untree.co" class="img-fluid">
          <img src="../resources/images/slider-2.jpg" alt="Free HTML Template by Untree.co" class="img-fluid">
          <img src="../resources/images/slider-4.jpg" alt="Free HTML Template by Untree.co" class="img-fluid">
        </div>
      </div>
        ...
        <div class="col-lg-4">
          ...
          <div class="custom-block" data-aos="fade-up">
            ...
            <a href="https://vimeo.com/342333493" data-fancybox class="video-wrap">
              ...
              <img src="../resources/images/bg_1.jpg" alt="Image" class="img-fluid rounded">
            </a>
          </div> <!-- END .custom-block -->
        </div>
        <div class="col-lg-4">
        ...
        <div class="col-lg-10">
          ...
          <div class="row">
            <div class="col-lg-3 mb-4">
              <div class="team">
                <img src="../resources/images/person_1.jpg" alt="Image" class="img-fluid mb-4">
                <div class="px-3">
            ...
            <div class="col-lg-3 mb-4">
              <div class="team">
                <img src="../resources/images/person_2.jpg" alt="Image" class="img-fluid mb-4">
                <div class="px-3">
            ...
            <div class="col-lg-3 mb-4">
              <div class="team">
                <img src="../resources/images/person_4.jpg" alt="Image" class="img-fluid mb-4">
                <div class="px-3">
            ...
            <div class="col-lg-3 mb-4">
              <div class="team">
                <img src="../resources/images/person_3.jpg" alt="Image" class="img-fluid mb-4">
                <div class="px-3">
