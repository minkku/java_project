				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label>ID</label> <input class="form-control" name='board.users_id_id'
							value="${board.users_id_id}" readonly="readonly">
					
					</div>

					
					<button id="modifyButton" data-oper='modify' class="btn btn-default"
...
$(document).ready(function () {
       ...
       function modifyButton() {
           var users_id_id = parseInt($("input[name='users_id_id']").val());
           var board_users_id_id = parseInt($("input[name='board.users_id_id']").val());

           // 두 값이 같으면 버튼 표시, 다르면 버튼 감춤
           if (users_id_id == board_users_id_id) {
               $("#modifyButton").show();
           } else {
               $("#modifyButton").hide();
           }
