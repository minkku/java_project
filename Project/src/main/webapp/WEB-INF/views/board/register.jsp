                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="/board/register" method="post" name="myForm">
						    ...
						    <small id="titleWarning" class="text-danger"></small>
						</div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>작성자</label> <input class="form-control" name='email' value="${email}" readonly="readonly">
                            </div>

                            <button type="submit" class="btn btn-default" onclick="return titleclick()">Submit Button</button>
