        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">한마디</h2>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              <h2 class="ftco-heading-2"><a href="#">SARA</a></h2>
              <ul class="list-unstyled">
                <li><a href="/book/allList" class="py-2 d-block">도서목록</a></li>
                <li><a href="/board/notice" class="py-2 d-block">공지사항</a></li>
              </ul>
            </div>
          </div>
          <!-- <div class="col-md-4">
